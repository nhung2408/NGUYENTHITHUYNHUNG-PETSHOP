<div class="sp-trong-gio">
    ...
    if(isset($_SESSION['yeuthich'])&&count($_SESSION['yeuthich'])>0){
        ...
        for($i=0;$i<$count;$i++){
            ...
            echo '<div class="xoa-mathang"><a href="xulyGio.php?idThu='.$_SESSION['yeuthich'][$i]['idSP'].'  "><img src="images/icon/delete.png" alt="Xóa" title="Bỏ"/> </a></div></div>';
        }}
    else if(!isset($_SESSION['yeuthich'])||count($_SESSION['yeuthich'])==0){
        echo '<h3 style="text-align: center">Không có sản phẩm</h3>';
    }?>
        <input name="" id="" class="btn btn-primary" type="button" value="Đặt Hàng">
</div>